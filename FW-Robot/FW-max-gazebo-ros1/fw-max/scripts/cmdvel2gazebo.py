    ...
    def __init__(self):
        ...
        self.steer_pubs = [
            rospy.Publisher(n, Float64, queue_size=1) for n in [
                '/fw_max/front_right_steering_position_controller/command',
                '/fw_max/front_left_steering_position_controller/command',
                '/fw_max/rear_right_steering_position_controller/command',
                '/fw_max/rear_left_steering_position_controller/command'
            ]
        ]
        
        self.drive_pubs = [
            rospy.Publisher(n, Float64, queue_size=1) for n in [
                '/fw_max/front_left_velocity_controller/command',
                '/fw_max/front_right_velocity_controller/command',
                '/fw_max/rear_left_velocity_controller/command',
                '/fw_max/rear_right_velocity_controller/command'
            ]
        ]
        ...
        self.L = 0.6             # 轴距 (m)
        self.T = 0.45            # 轮距 (m)
        self.wheel_radius = 0.125  # 车轮半径 (m)
        self.base_max_steer = math.radians(45)  # 最大转向角
